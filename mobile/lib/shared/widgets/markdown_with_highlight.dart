...
import 'package:epr_legal_mobile/l10n/app_localizations.dart';
// import 'package:epr_legal_mobile/theme/theme_factory.dart' show getPlatformFontFallback; // Desktop-only, removed
import 'package:provider/provider.dart';
import 'package:google_fonts/google_fonts.dart';
import '../../core/providers/settings_provider.dart';
// import 'package:epr_legal_mobile/desktop/html_preview_dialog.dart'; // Desktop-only, removed
                      ...
                      InkWell(
                        onTap: () async {
                          ...
                          if (Platform.isAndroid || Platform.isIOS) {
                            ...
                            // Desktop (macOS/Windows): open dialog - NOT AVAILABLE FOR ANDROID BUILD
                            // try {
...
class AtxHeadingMd extends BlockMd {
  ...
  TextStyle _headingTextStyle(BuildContext ctx, GptMarkdownConfig cfg, int level) {
    ...
    return base.copyWith(
      ...
      fontFamilyFallback: const [], // getPlatformFontFallback() - Desktop-only, removed
    );
  }
}
