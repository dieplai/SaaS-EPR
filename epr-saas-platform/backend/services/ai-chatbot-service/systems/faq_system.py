...
CHỈ TRẢ LỜI MỘT SỐ:"""
    ...
    def handle_faq_query(self, question: str) -> Optional[Dict]:
        ...
        # DISABLED: FAQ system is too aggressive and reduces chatbot quality
        # All queries should go through RAG for better context-aware responses
        logger.info("FAQ system disabled - all queries will use RAG")
        return None

        # Original FAQ logic below (disabled)
