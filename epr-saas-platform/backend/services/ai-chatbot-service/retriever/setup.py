...
from systems.legal_prompts import ENHANCED_LEGAL_ANALYSIS_PROMPT, REFINE_PROMPT_TEMPLATE
...
class RetrieverSystem:
        ...
        try:
            ...
            vector_store_info = VectorStoreInfo(
                ...
                metadata_info=[
                    ...
                    MetadataInfo(
                        name="document",
                        description="Tên tài liệu pháp luật gốc (ví dụ: 'Nghị định 08/2022/NĐ-CP', 'Luật Bảo vệ Môi trường 72/2020')",
                        type="string",
                    ),
                    MetadataInfo(
                        name="file_name",
                        description="Tên file PDF của tài liệu (ví dụ: 'nghi-dinh-08-2022.pdf')",
                        type="string",
                    ),
                    MetadataInfo(
                        name="pdf_url",
                        description="Đường dẫn URL đến file PDF gốc",
                        type="string",
                    ),
                ],
            )
    ...
    def _setup_query_engine(self, retriever):
        ...
        # Use professional legal consultant prompts
        qa_prompt_template = PromptTemplate(ENHANCED_LEGAL_ANALYSIS_PROMPT)
        refine_prompt_template = PromptTemplate(REFINE_PROMPT_TEMPLATE)
